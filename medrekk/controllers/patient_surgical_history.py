...
from medrekk.models.patient import PatientSurgicalHistory
from medrekk.schemas.patients import PatientSurgicalHistoryCreate, PatientSurgicalHistoryUpdate
