...
from medrekk.models.patient import PatientHeartRate
from medrekk.schemas.patients import PatientHeartRateCreate, PatientHeartRateUpdate
...
def create_patient_heartrate(
    ...
    try:
        ...
        if isinstance(e.orig, UniqueViolation):
            ...
            if args.find("uc_heartrate_patient_dt"):
                raise HTTPException(
