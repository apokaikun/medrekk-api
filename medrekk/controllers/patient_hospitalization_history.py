...
from medrekk.models.patient import PatientHospitalizationHistory
from medrekk.schemas.patients import PatientHospitalizationHistoryCreate, PatientHospitalizationHistoryUpdate
...
def read_hospitalization_histories(
    ...
    hospitalization_histories = (
        db.query(PatientHospitalizationHistory)
        .filter(PatientHospitalizationHistory.id == patient_id)
