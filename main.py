...
from medrekk.routes.patient_hospitalization_history import (
    hospitalization_history_routes,
)
from medrekk.routes.patient_medical_history import medical_history_routes
from medrekk.routes.patient_ob_history import ob_history_routes
